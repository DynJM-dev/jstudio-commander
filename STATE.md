...
## Current State
- Phase: **Phase F complete (Coder-14). Structured chat message rendering, auto-split-on-spawn, pane-adoption hardening, prompt-detection bypass-permissions kill-switch, team-lead adoption + parent-inherited coder naming.**
